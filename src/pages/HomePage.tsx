    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center py-24">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-[#fff7d1] to-[#ffd700] animate-gradient-x drop-shadow-[0_0_20px_rgba(255,255,255,0.15)]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="px-8 py-4 rounded-full font-semibold text-lg text-gray-900 bg-gradient-to-r from-white via-[#fff7d1] to-[#ffd700] animate-gradient-x shadow-lg hover:shadow-[0_0_25px_rgba(255,255,200,0.4)] hover:scale-105 transition-all text-center"
              >
                Join the Challenge
              </a>
              <a
                href="/about#competition"
                className="px-8 py-4 rounded-full font-semibold text-lg border-2 border-yellow-300 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#fff7d1] to-[#ffd700] animate-gradient-x hover:bg-yellow-200/10 hover:text-gray-900 transition-all hover:shadow-[0_0_25px_rgba(255,255,200,0.3)] text-center"
              >
                Submit Your Idea
              </a>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 animate-fade-in">
        <div className="bg-white/10 backdrop-blur-xl border border-yellow-300/20 rounded-2xl p-10 shadow-[0_0_30px_rgba(255,215,0,0.15)] hover:shadow-[0_0_45px_rgba(255,215,0,0.25)] transition-all">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#fff7d1] to-[#ffd700] animate-gradient-x">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-yellow-400/20 rounded-2xl p-10 shadow-[0_0_25px_rgba(255,215,0,0.1)] hover:shadow-[0_0_40px_rgba(255,215,0,0.2)] transition-all">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-gray-200 text-sm sm:text-base">
              {[
                ...
                >
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-[#fff7d1] to-[#ffd700] animate-gradient-x text-lg font-semibold">
                    ✓
                  </span>
                  <span>{item}</span>
                </div>

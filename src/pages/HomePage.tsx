...
const HomePage: React.FC = () => {
  return (
    <section id="home" className="min-h-screen homeone-bg bg-pattern flex items-center relative overflow-hidden">
      ...
      <section className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-yellow-300 mb-4">The Global Youth Entrepreneurship Challenge (GYEC)</h2>
            <p className="text-white text-base sm:text-lg leading-relaxed mb-4">
